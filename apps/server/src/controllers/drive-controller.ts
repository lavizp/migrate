...
export const listDriveFiles = async (req: AuthRequest, res: Response) => {
  try {
...
export const getDriveFile = async (req: AuthRequest, res: Response) => {
  try {
...
export const createDriveFile = async (req: AuthRequest, res: Response) => {
  try {
    const schema = z.object({
      name: z.string().min(1),
      content: z.string(),
...
export const downloadDriveFile = async (req: AuthRequest, res: Response) => {
  try {
...
export const deleteDriveFile = async (req: AuthRequest, res: Response) => {
  try {
